module ActiveAdminScopedCollectionActions
  module ResourceExtension
    ...
    def scoped_collection_actions_sidebar_section
      ActiveAdmin::SidebarSection.new "Групповые операции", only: :index, if: scoped_collection_sidebar_condition do

        div "По всем страницам."
        ...
        active_admin_config.scoped_collection_actions.each do |key, options={}|
          ...
          b_data[:confirm] = options.fetch(:confirm, 'Изменить поля:')
